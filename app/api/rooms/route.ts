...
export async function POST(req: NextRequest) {
  ...
  await Room.create({ roomId, name: name || 'Custom Room', hostId: auth.userId, maxPlayers: maxPlayers || 8, rounds: rounds || 5, drawTime: drawTime || 60, isPrivate: !!isPrivate, password: String(password || '').trim(), phase: 'waiting', playerCount: 0 })
