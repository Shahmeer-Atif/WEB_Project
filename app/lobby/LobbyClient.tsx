...
const WordOfDayCard = () => {
  ...
  useEffect(() => {
    fetch('/api/wordofday').then(r => r.json()).then(d => {
      setWod({ word: d.word || 'PARADOX', hint: d.hint || '', bonusPoints: d.bonusPoints || 500 })
      setLetters(Array((d.word || 'PARADOX').length).fill(false))
    }).catch(() => {
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 720px) {
          .lobby-root { height: auto !important; min-height: 100vh !important; overflow-y: auto !important; display: flex !important; }
          .main-grid { display: flex !important; flex-direction: column !important; overflow: visible !important; }
          .quick-play-wrapper { grid-row: auto !important; height: auto !important; }
          .hide-on-mobile { display: none !important; }
          .lobby-header { height: auto !important; flex-wrap: wrap !important; padding: 12px 16px !important; justify-content: center !important; gap: 12px !important; }
          .lobby-nav { position: static !important; transform: none !important; order: 3 !important; width: 100% !important; justify-content: center !important; }
