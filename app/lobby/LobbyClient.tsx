...
const TopNav = ({ user, onLogout, onFriendsOpen, pendingCount, invites, onInvitesOpen }: {
  ...
  <header className="lobby-header" style={{ width: '100%', padding: '0 32px', height: 58, display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'relative', flexShrink: 0, borderBottom: '1px solid rgba(27,24,48,0.06)', background: 'rgba(251,246,236,0.85)', backdropFilter: 'blur(12px)', zIndex: 10 }}>
    <a href="/lobby" className="logo-link" style={{ display: 'flex', alignItems: 'center', gap: 9, textDecoration: 'none', flexShrink: 0, zIndex: 2 }}>
      ...
      <div className="logo-text" style={{ lineHeight: 1 }}>
    ...
    <div className="header-controls" style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0, zIndex: 2 }}>
      ...
      <button onClick={onLogout} title="Log out" className="nav-btn" style={{ width: 30, height: 30, borderRadius: '50%', background: 'rgba(255,255,255,0.7)', border: '1px solid rgba(27,24,48,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', color: '#5A5275' }}>
  ...
  return (
    <div style={{ height: '100vh', overflow: 'hidden', backgroundColor: '#FBF6EC', backgroundImage: `radial-gradient(rgba(27,24,48,0.032) 1px, transparent 1px), radial-gradient(rgba(27,24,48,0.022) 1px, transparent 1px)`, backgroundSize: '3px 3px, 7px 7px', backgroundPosition: '0 0, 1px 1px', fontFamily: "'Inter', system-ui, sans-serif", display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{ flex: 1, minHeight: 0, padding: '14px 32px 14px', display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        {/* Added specific CSS class names for mobile targeting */}
        <div className="main-grid" style={{ flex: 1, minHeight: 0, display: 'grid', gridTemplateColumns: '1fr 1fr', gridTemplateRows: '1fr auto', gap: 14 }}>
          <div className="quick-play-wrapper" style={{ gridRow: 'span 2', display: 'flex', flexDirection: 'column', minHeight: 0 }}>
            <QuickPlayCard onQuickPlay={handleQuickPlay} searching={searching} onJoin={async (id, pw) => {
              try { await handleJoin(id, pw) } catch (e: any) { throw e }
            }} />
          </div>
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 720px) {
          /* Target specific elements by class to guarantee vertical layout */
          .main-grid { 
          ...
          /* Hide non-critical text to save horizontal space on mobile, keep emojis */
          .btn-text { display: none !important; }
          .coin-pill { display: none !important; }
          .user-pill-text { display: none !important; }
          .user-pill { gap: 0 !important; padding: 3px !important; }
